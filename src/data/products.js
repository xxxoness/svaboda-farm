...
const PRODUCT_PHOTOS = {
  ...
  f3: '/assets/products/plums.png',
  f4: '/assets/products/grapes.png',
  f5: '/assets/products/oranges.png',
  f6: '/assets/products/bananas.png',
  f7: '/assets/products/kiwi.png',
  f8: '/assets/products/mandarins.png',
  f9: '/assets/products/cherries.png',
  f10: '/assets/products/strawberries.png',
  f11: '/assets/products/blueberries.png',
  f12: '/assets/products/watermelon.png',
